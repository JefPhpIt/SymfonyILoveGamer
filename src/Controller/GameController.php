...
{
    #[Route('/', name: 'app_game')]
    public function index(Request $request, HttpClientInterface $client, ParameterBagInterface $params,EntityManagerInterface $entityManager, UserInterface $user): Response
    {
    ...
    #[Route('/favorites', name:'game_favorites')]

    public function favorites(): Response
    {
     $favorites = $this->getUser()->getGames();
